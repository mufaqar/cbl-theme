...
<section class="my-16">
    <div class="container mx-auto px-4">
        <div class="mb-10">
            <h2 class="text-2xl font-bold">Compare <?php echo FormatData($type) ?> <?php echo get_display_text_by_type($type); ?> in <span
                                    ...
                                    if ($compairs->have_posts()) :
                                        while ($compairs->have_posts()) :
                                            ...
                                            if ($type == 'internet') {
                                             ...
                                             // var_dump($services);
                                                $data = [
                                                    'installation_type' => $services['installation_type'] ?? 'N/A',
                                                    'contract' => $services['contract_term'] ?? 'N/A',
                                                    'setup_fee' => "$".$services['setup_fee'] ?? 'N/A',
                                                    'early_termination_fee' => "$".$services['early_termination_fee'] ?? 'N/A',
